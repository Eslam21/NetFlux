...
CREATE TABLE `rated` (
  ...
  KEY `movieid` (`movieid`),
  CONSTRAINT `rated_ibfk_1` FOREIGN KEY (`movieid`) REFERENCES `movies` (`movieid`) ON DELETE CASCADE,
  CONSTRAINT `rated_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `persons` (`userid`) ON DELETE CASCADE
