  ...
  movies.forEach((movie, index) => {
    ...
    movieEl.innerHTML = `
     ...
     <nav class="menu">
          ...
          <button class="myButton" id="watch${id}"><ion-icon name="eye"></ion-icon></button>
          <button class="myButton" id="heart${id}"><ion-icon name="heart"></ion-icon>
    ...
    let watchId = document.getElementById(`watch${id}`);
    let heartId = document.getElementById(`heart${id}`);
